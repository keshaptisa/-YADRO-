...
1. перебираются все подмножества потребителей;
2. перебираются все подмножества генераторов;
3. для каждого подмножества потребителей ищется самый дешевый набор генераторов, способный покрыть нужный объем;
4. из всех допустимых решений выбирается оптимальное по заранее зафиксированному приоритету критериев.
